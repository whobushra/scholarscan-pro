      ...
      <div className="flex-1 flex">
        ...
        <div className="hidden lg:flex flex-1 relative overflow-hidden">
          {banners.map((src, i) => (
            <img
              ...
              style={{ opacity: currentBanner === i ? (transitioning ? 0 : 1) : 0 }}
            />
          ))}
          {/* Overlay gradient */}
          <div className="absolute inset-0 bg-gradient-to-r from-[#1a3c5e]/70 via-[#1a3c5e]/30 to-transparent" />
          {/* Text overlay */}
          <div className="absolute bottom-12 left-12 right-12 z-10">
            ...
            <div className="flex gap-2 mt-6">
              {banners.map((_, i) => (
                <button
                  key={i}
                  onClick={() => { setTransitioning(true); setTimeout(() => { setCurrentBanner(i); setTransitioning(false); }, 400); }}
                  className="h-1.5 rounded-full transition-all duration-300"
                  style={{
                    width: currentBanner === i ? 28 : 8,
                    backgroundColor: currentBanner === i ? '#c9a84c' : 'rgba(255,255,255,0.4)',
                  }}
                />
              ))}
            </div>
        ...
        <div className="w-full lg:w-[480px] xl:w-[520px] flex flex-col justify-center px-8 sm:px-12 lg:px-14 py-12 bg-[#f8f7f4]">
          ...
          <div className="mb-10">
            ...
            <div className="mt-4">
              <h1 className="text-2xl font-bold text-[#1a3c5e]">Welcome back</h1>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-[#1a3c5e] uppercase tracking-wider">
                Username / Email
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-11 pl-10 pr-4 text-sm rounded-xl border border-[#d1d5db] bg-white text-[#1a3c5e] placeholder:text-[#9ca3af] focus:outline-none focus:ring-2 focus:ring-[#c9a84c]/40 focus:border-[#c9a84c] transition-all"
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-11 pl-10 pr-11 text-sm rounded-xl border border-[#d1d5db] bg-white text-[#1a3c5e] placeholder:text-[#9ca3af] focus:outline-none focus:ring-2 focus:ring-[#c9a84c]/40 focus:border-[#c9a84c] transition-all"
                />
                <button
                  type="button"
            ...
            <div className="flex justify-end">
              <button
                type="button"
                className="text-xs font-medium text-[#c9a84c] hover:text-[#b08d3a] transition-colors"
              >
                Forgot Password?
              </button>
            </div>
            ...
            <button
              type="button"
              className="w-full h-11 rounded-xl text-sm font-medium border border-[#d1d5db] text-[#1a3c5e] bg-white hover:bg-[#f1f0ed] transition-colors"
            >
              Sign in with OTP
            </button>
          </form>
